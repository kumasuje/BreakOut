...
/* The Commons interface has some globally used constants like window width,
 * window height, etc.
 */
public interface Commons {
    ...
    public static final String PIC_WALL = "/wall.png";
    public static final String SOUND_BUMP = "/bump.wav";
    public static final String SOUND_PING = "/ping.wav";
